 ...
 return (
   <View style={styles.container}>
    ...
    <View style={styles.headerContent}>
      <View style={{ width: '65%' }}>
        <Text style={styles.house}>Applebees</Text>
      </View>
    ...
    <ScrollView horizontal showsHorizontalScrollIndicator={false} style={{paddingHorizontal: 15, marginTop: 35 }}>
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/applebees2.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
      ...
      <View style={styles.slide}>
        <Image
        source={require('../assets/applebees3.jpg')}
        style={{width: 90, height: 90, borderRadius: 8}}
        />
      </View>
    </ScrollView>
